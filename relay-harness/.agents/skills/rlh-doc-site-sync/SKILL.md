...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [rlh-doc-standards](../rlh-doc-standards/SKILL.md) when deciding where content belongs or changing product documentation prose.
...
Use [rlh-pre-push-checks](../rlh-pre-push-checks/SKILL.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.
