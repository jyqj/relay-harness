...
| Package names without the group prefix (continuing rlh-<tail>) | `rlh-runtime`/`rlh-web-ui` lose their belonging in the flat npm namespace; the cost is one explicit paths entry per package |
