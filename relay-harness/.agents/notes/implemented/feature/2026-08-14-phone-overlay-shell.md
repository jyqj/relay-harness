...
**Bind `rlh web` to `0.0.0.0` for phone access.** Rejected: the Host fence and missing auth make an unauthenticated LAN bind unsafe. The desktop reverse proxy keeps rlh on loopback.
