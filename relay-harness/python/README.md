...
Python packages for driving Relay Harness as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.

## Packages

| Directory | Dist / module | Role |
|---|---|---|
| [sdk](sdk/README.md) | `relay-harness-sdk` / `relay_harness` | High-level turns API and lower-level JSON-RPC client |
| [sdk-runtime](sdk-runtime/README.md) | `relay-harness-runtime-bin` / `relay_harness_runtime` | Bundled runtime binaries and default agent configuration |
