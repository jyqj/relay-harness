...
| [0003](0003-agent-runtime.md) | agent loop；本地验证与路由解耦 | 部分取代（Rust 实现被 0005 取代；loop 语义与验证原则仍有效） |
| [0004](0004-data-and-action-boundary.md) | 显式文件上下文、最小权限和本地状态 | 已接受 |
| [0005](0005-adopt-ts-harness-runtime.md) | 根目录 TypeScript Relay Harness 作为运行时 | 已接受 |
