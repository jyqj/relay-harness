...
Context Engine 已在 [`packages/context/`](../../packages/context/README.md) 原生实现。代码检索由 monorepo 内 [`packages/index/`](../../packages/index/README.md) 提供，不依赖仓库外的 CodeCortex checkout。完成状态及证据见 [`../feature-status.json`](../feature-status.json)；确切协议与限制见：
