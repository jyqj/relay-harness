- banner:
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Use web_search once with queries ["Relay Harness snapshot search","Relay Harness multi-query search"]. Then reply exactly SEARCH_DONE and stop. {{clock}}
- button "Copy":
  - img
...
- button "Search Relay Harness snapshot search, Relay Harness multi-query search":
  - img
  - img
  - text: Search Relay Harness snapshot search, Relay Harness multi-query search
