...
// regression the external report asked for (rlh-external/issues#107 →
// relay-harness#1406): "increase an 800×720 browser regression test and
...
import type {} from '@relay-harness/rlh-plan-mode'
...
describe('web e2e: plan chip click area at the narrow viewport', () => {
  ...
  beforeAll(async () => {
    ...
    // The model-seat geometry is an explicit Detailed view surface.
