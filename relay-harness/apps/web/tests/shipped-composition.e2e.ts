...
import { canonicalPath, writableRoots } from '@relay-harness/rlh-sandbox'
...
import type {} from '@relay-harness/rlh-permission-presets'
...
/**
 * `glob` and `grep` come from `rlh-tool-fs-search`, which spawns the PACKAGED
