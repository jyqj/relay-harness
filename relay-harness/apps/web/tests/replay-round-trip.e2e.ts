...
// in the temp workspace) all run; the model adapter is rlh-llm-replay (keyless)
...
// Record: RLH_SNAPSHOT=record rewrites session.jsonl, then a keyless
// RLH_SNAPSHOT=refresh regenerates ui.expected.md.
