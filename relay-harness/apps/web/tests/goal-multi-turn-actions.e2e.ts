...
import { parseSessionLog } from '@relay-harness/rlh-llm-replay'
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@relay-harness/rlh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@relay-harness/rlh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@relay-harness/rlh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@relay-harness/rlh-skill-filesystem"}\n',
