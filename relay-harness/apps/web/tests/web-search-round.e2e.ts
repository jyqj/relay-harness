...
import { WEB_SEARCH_MAX_RESULTS } from '@relay-harness/rlh-tool-web'
import {
...
const QUERIES = ['Relay Harness snapshot search', 'Relay Harness multi-query search'] as const
const PROMPT = `Use web_search once with queries ${JSON.stringify(QUERIES)}. Then reply exactly SEARCH_DONE and stop.`
const SEARCH_CREDENTIAL_REF = credentialRef('RLH_WEB_SEARCH_E2E_KEY')
