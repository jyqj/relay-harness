 ...
 * rlh CLI invocation). Without it the market would default to `web` and
...
export function apply(ctx, config) {
    ctx.inject(['webServer', 'loader'], (hostCtx) => {
        ...
        if (desktopProfiles === undefined) {
            ...
            host.effect(() => mountMarketRoutes(host, resolved), 'rlh-market: http routes');
            return;
        }
        ...
        // https://github.com/anywhere-labs/deepseek-harness-desktop/blob/4f68147091e585aaa1d815f99d30a657b3842d7c/rlh-plugin-desktop/docs/plugin-services.md#L190-L243
        // Ordinary RLH keeps the existing CLI path above.
        hostCtx.inject(['desktopPnpm'], (desktopCtx) => {
            ...
            }, 'rlh-market: Desktop http routes and package operations');
        });
    });
}
