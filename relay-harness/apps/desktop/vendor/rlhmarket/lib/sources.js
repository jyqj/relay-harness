 ...
 * subpackages, e.g. rlh-plugins#theme-gallery).
 */
...
export function findInstalledAlias(entry, installed) {
    ...
    for (const [name, spec] of Object.entries(installed)) {
        ...
        if (m !== null) {
            ...
            // lists distinct plugins under one name (both rlh-usage-stats, four
            // rlh-memory…), so a github-installed dependency is the entry's plugin
