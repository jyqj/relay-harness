 ...
 * service — every rlh before 0.1.0-rc.7 — simply never runs any of this and
...
export declare const MARKET_SETTINGS_NS: import("@relay-harness/rlh-settings").SettingsNamespace;
