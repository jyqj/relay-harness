...
| --- | --- | --- | --- |
| `@relay-harness/cosmokit` | `cosmokit` | [github.com/relay-harness/cosmokit](https://github.com/relay-harness/cosmokit) | MIT |
| `@relay-harness/schemastery` | `schemastery` | [github.com/relay-harness/schemastery](https://github.com/relay-harness/schemastery) | MIT |
| `@relay-harness/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@relay-harness/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@relay-harness/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/relay-harness/cordis](https://github.com/relay-harness/cordis) | MIT |
| `@relay-harness/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/relay-harness/cordis](https://github.com/relay-harness/cordis) | MIT |
| `@relay-harness/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/relay-harness/cordis](https://github.com/relay-harness/cordis) | MIT |
| `@relay-harness/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/relay-harness/cordis](https://github.com/relay-harness/cordis) | MIT |
| `@relay-harness/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/relay-harness/cordis](https://github.com/relay-harness/cordis) | MIT |
...
The installed SDK 0.3.240 declares the following optional platform packages. Each carries the official Claude Code 2.1.240 executable; the package identities and versions come from the SDK manifest, while the declared license field is verified against the platform payload installed for the current host.

| Optional platform package | Version | Declared license |
| --- | --- | --- |
| [`@anthropic-ai/claude-agent-sdk-darwin-arm64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-darwin-arm64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-darwin-x64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-darwin-x64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-linux-arm64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-linux-arm64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-linux-arm64-musl`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-linux-arm64-musl) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-linux-x64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-linux-x64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-linux-x64-musl`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-linux-x64-musl) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-win32-arm64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-win32-arm64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
| [`@anthropic-ai/claude-agent-sdk-win32-x64`](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk-win32-x64) | 0.3.240 | SEE LICENSE IN LICENSE.md |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any Relay Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `relay-harness-sdk` |
