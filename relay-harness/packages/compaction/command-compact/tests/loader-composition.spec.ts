...
} from '@relay-harness/rlh-compaction'
import * as commandCompact from '@relay-harness/rlh-command-compact'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'rlh-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@relay-harness/rlh-command-compact', commandCompact],
    ])
