...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  root = await mkdtemp(join(tmpdir(), 'rlh-token-meter-loader-'))
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@relay-harness/rlh-token-meter', TokenMeter],
    ['@relay-harness/rlh-compaction-tool-result-pruner', ToolResultPruner],
    ['@relay-harness/rlh-compaction-basic', BasicCompactionEngine],
  ])
