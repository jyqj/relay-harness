 ...
 *
 * @module @relay-harness/rlh-compaction-basic/summarizer
 */

import type { Context } from '@relay-harness/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@relay-harness/rlh-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'rlh-compaction-basic' },
    }),
  ]
