/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-subagent`.
 * @module @relay-harness/rlh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-subagent'
