/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-subagent-control`.
 * @module @relay-harness/rlh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-subagent-control'
