/**
 * Package-owned invariant companion for `@relay-harness/rlh-subagent-codex`.
 * @module @relay-harness/rlh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-subagent-codex'
