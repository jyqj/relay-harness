...
import type { SessionProjectionRegistry } from '@relay-harness/rlh-session-projection'
import type { SessionProjectionCache } from '@relay-harness/rlh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @relay-harness/rlh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @relay-harness/rlh-session)',
