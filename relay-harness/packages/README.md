...
| [`memory/`](memory/README.md) | Long-term-memory capability family: governed revisions, SQLite provider, Agent recall, and model-facing tools | Product — stable API |
...
| [`tracker/`](tracker/README.md) | Issue tracker capability family: provider registry and session-bound tools + the Linear provider | Product — stable API |
| [`automation/`](automation/README.md) | Opt-in tracker-driven issue automation: orchestrator, runner, workspace, workflow, orchestration seams + their providers | Product — stable API |
...
| [`bundle/`](bundle/README.md) | Installable `rlh --profile` patch layers | Product — stable API |
