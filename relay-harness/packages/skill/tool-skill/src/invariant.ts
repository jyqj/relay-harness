/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-skill`.
 * @module @relay-harness/rlh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-skill'
