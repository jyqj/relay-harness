 ...
 * @module @relay-harness/rlh-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('rlh-code-runtime-worker-thread: worker entry loaded outside a worker thread')
