/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-title-first-prompt-llm`.
 * @module @relay-harness/rlh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-title-first-prompt-llm'
