/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-stats`.
 * @module @relay-harness/rlh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-stats'
 ...
 * ids) are owned and runtime-checked by rlh-agent-loop and the session
 * surface, not here.
 */
