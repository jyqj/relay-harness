/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-title-llm`.
 * @module @relay-harness/rlh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-title-llm'
