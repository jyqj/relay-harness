 ...
 * @module @relay-harness/rlh-session-title-llm
 */

import type { Context } from '@relay-harness/cordis'
import z from '@relay-harness/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@relay-harness/rlh-llm'
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'rlh-session-title-llm' },
  })]
