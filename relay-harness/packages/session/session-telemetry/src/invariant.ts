/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-telemetry`.
 * @module @relay-harness/rlh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-telemetry'
