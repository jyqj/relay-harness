/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-title`.
 * @module @relay-harness/rlh-session-title/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-title'
