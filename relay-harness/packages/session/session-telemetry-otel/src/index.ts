/**
 * OpenTelemetry Service Provider for the Relay Harness telemetry capability.
 *
 ...
 *
 * @module @relay-harness/rlh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@relay-harness/schemastery'
import type { Context } from '@relay-harness/cordis'
import type {} from '@relay-harness/rlh-command-feedback'
import {
...
} from '@relay-harness/rlh-session-telemetry'
import { APP_IDENTITY } from '@relay-harness/rlh-llm'
...
// version (same pattern as rlh-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@relay-harness/rlh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@relay-harness/rlh-session-telemetry-otel/ops', version)
