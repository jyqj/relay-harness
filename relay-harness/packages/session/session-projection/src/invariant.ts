/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-projection`.
 * @module @relay-harness/rlh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-projection'
