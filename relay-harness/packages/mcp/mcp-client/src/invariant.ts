/**
 * Package-owned invariant companion for `@relay-harness/rlh-mcp-client`.
 * @module @relay-harness/rlh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-mcp-client'
