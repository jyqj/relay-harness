 ...
 *
 * @module @relay-harness/rlh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@relay-harness/rlh-shell'
import type { SandboxMode } from '@relay-harness/rlh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@relay-harness/rlh-sandbox'
 ...
 * rendering story, owned by `@relay-harness/rlh-shell` so `rlh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@relay-harness/rlh-shell'
