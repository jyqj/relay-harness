/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-bash`.
 * @module @relay-harness/rlh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-bash'
