 ...
 * mirror of `@relay-harness/rlh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @relay-harness/rlh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@relay-harness/rlh-shell'
import type { RunnerFailureRule } from '@relay-harness/rlh-sandbox'
