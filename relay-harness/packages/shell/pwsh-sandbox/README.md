...
- **Reads are unrestricted** on Windows (the ACL runner restricts writes only); the read boundary is documented in `@relay-harness/rlh-sandbox-windows-acl`.
