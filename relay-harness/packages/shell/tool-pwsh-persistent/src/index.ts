 ...
 * @module @relay-harness/rlh-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@relay-harness/rlh-terminal'
...
const SHELL_PROMPT = '__RLH_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__RLH_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__RLH_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
