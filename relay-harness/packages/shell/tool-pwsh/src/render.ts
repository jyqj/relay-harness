 ...
 * `rlh-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @relay-harness/rlh-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@relay-harness/rlh-shell'
...
/* jscpd:ignore-start -- deliberate twin of rlh-tool-bash/render.ts (Agent Note). */
