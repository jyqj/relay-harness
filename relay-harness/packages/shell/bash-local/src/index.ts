 ...
 * @module @relay-harness/rlh-bash-local
 */
...
export class LocalBashExecutor extends ShellExecutor {
  ...
  resolve(request: ShellExecRequest): ShellExecSpec {
    ...
    return {
      ...
      // Carry stdin/ordinary env/trusted rlhEnv through verbatim — optional,
  ...
  private spawnSpec(
    ...
    return {
      ...
      signal,
      // One explicit env map for the seam, layered so the trusted rlhEnv
