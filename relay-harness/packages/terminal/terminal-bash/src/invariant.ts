/**
 * Package-owned invariant companion for `@relay-harness/rlh-terminal-bash`.
 * @module @relay-harness/rlh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-terminal-bash'
