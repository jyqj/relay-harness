/**
 * Package-owned invariant companion for `@relay-harness/rlh-terminal`.
 * @module @relay-harness/rlh-terminal/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-terminal'
