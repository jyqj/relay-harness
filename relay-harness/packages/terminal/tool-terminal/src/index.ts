 ...
 * @module @relay-harness/rlh-tool-terminal
 */
...
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@relay-harness/rlh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @relay-harness/rlh-jobs and @relay-harness/rlh-tool-jobs')
