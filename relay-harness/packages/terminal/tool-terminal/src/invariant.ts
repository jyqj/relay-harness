/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-terminal`.
 * @module @relay-harness/rlh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-terminal'
