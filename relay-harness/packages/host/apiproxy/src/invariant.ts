/**
 * Package-owned invariant companion for `@relay-harness/rlh-host-apiproxy`.
 * @module @relay-harness/rlh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-host-apiproxy'
