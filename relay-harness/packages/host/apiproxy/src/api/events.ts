...
import type { ApprovalOutcome, ApprovalRequestId } from '@relay-harness/rlh-user-approval/types'
import type { Message } from '@relay-harness/rlh-llm/types'
import type { MessageId } from '@relay-harness/rlh-llm/brand'
import type { CallId } from '@relay-harness/rlh-llm/brand'
import type { JsonValue, SessionEvent, SessionId, SessionOrigin } from '@relay-harness/rlh-session/types'
import type { ToolCallView, ToolResultView } from '@relay-harness/rlh-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// rlh-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@relay-harness/rlh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
