 ...
 * @module @relay-harness/rlh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@relay-harness/rlh-host-directory-picker-native',
  browse: '@relay-harness/rlh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@relay-harness/rlh-client-ui-directory-picker-native',
  browse: '@relay-harness/rlh-client-ui-directory-picker-browse',
}
