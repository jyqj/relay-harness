...
import HttpServer from '@relay-harness/rlh-host-webserver'
import type { DirectoryPicker } from '@relay-harness/rlh-host-directory-picker'
import BrowseDirectoryPicker from '@relay-harness/rlh-host-directory-picker-browse'
import NativeDirectoryPicker from '@relay-harness/rlh-host-directory-picker-native'
...
const AUTO = '@relay-harness/rlh-host-directory-picker-auto'
const NATIVE = '@relay-harness/rlh-host-directory-picker-native'
const BROWSE = '@relay-harness/rlh-host-directory-picker-browse'
const NATIVE_SURFACE = '@relay-harness/rlh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@relay-harness/rlh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  root = await mkdtemp(join(tmpdir(), 'rlh-directory-picker-auto-'))
...
function stubAttendedHost(): void {
  fakeBin = mkdtempSync(join(tmpdir(), 'rlh-picker-bin-'))
