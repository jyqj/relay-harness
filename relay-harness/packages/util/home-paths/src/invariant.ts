/**
 * Package-owned invariant companion for `@relay-harness/rlh-home-paths`.
 * @module @relay-harness/rlh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-home-paths'
