/**
 * Package-owned invariant companion for `@relay-harness/rlh-native-command`.
 * @module @relay-harness/rlh-native-command/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-native-command'
