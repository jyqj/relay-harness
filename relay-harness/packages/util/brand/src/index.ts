 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in rlh-llm (tool-call
 * correlation), the shared agent/session `SessionId` in rlh-session, and
 * `JobId` in rlh-jobs. Branding is for ids that cross package boundaries and
 ...
 * package.
 *
 * @module @relay-harness/rlh-brand
 */
