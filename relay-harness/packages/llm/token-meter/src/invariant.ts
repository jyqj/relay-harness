/**
 * Package-owned invariant companion for `@relay-harness/rlh-token-meter`.
 * @module @relay-harness/rlh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-token-meter'
