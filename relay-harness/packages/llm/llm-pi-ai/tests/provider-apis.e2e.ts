...
import LlmRuntime, { createUserMessage, CallId } from '@relay-harness/rlh-llm'
import type { Message, ToolSchema } from '@relay-harness/rlh-llm'
...
const openAIBaseURL = process.env.RLH_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.RLH_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.RLH_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.RLH_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
