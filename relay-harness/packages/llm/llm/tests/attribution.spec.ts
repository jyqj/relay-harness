...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@relay-harness/rlh-llm'
import type { AppIdentity } from '@relay-harness/rlh-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `relay-harness/${manifest.version} (+https://github.com/jyqj/relay-harness)`,
    )
  })
