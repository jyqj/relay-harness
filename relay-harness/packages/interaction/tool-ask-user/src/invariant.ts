/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-ask-user`.
 * @module @relay-harness/rlh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-ask-user'
