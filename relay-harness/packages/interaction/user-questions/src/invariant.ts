/**
 * Package-owned invariant companion for `@relay-harness/rlh-user-questions`.
 * @module @relay-harness/rlh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-user-questions'
