/**
 * rlh-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@relay-harness/rlh-brand`; this module
 ...
 * loading the host plugin's Context merges — the `rlh-llm/brand` shape.
 *
 * @module @relay-harness/rlh-commands/brand
 */
