 ...
 * streams large files, and rejects binary data; line windows belong to `rlh-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @relay-harness/rlh-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@relay-harness/rlh-fs'
