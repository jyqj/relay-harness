 ...
 * ({@link module:@relay-harness/rlh-tool-fs-search/glob} /
 * {@link module:@relay-harness/rlh-tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @relay-harness/rlh-tool-fs-search
 */
