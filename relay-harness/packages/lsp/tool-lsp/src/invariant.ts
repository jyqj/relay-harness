/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-lsp`.
 * @module @relay-harness/rlh-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-lsp'
