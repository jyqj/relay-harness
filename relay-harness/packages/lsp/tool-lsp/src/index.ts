 ...
 * `rlh-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @relay-harness/rlh-tool-lsp
 */
...
import { LspError } from '@relay-harness/rlh-lsp'
import type {} from '@relay-harness/rlh-lsp'
