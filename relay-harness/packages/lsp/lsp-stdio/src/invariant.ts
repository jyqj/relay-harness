/**
 * Package-owned invariant companion for `@relay-harness/rlh-lsp-stdio`.
 * @module @relay-harness/rlh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-lsp-stdio'
