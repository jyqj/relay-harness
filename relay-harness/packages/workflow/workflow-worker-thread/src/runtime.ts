 ...
 * @module @relay-harness/rlh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@relay-harness/rlh-llm'
import { SessionId } from '@relay-harness/rlh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@relay-harness/rlh-tools'
import type { ObjectJsonSchema } from '@relay-harness/rlh-tools'
import { isFatalWorkflowError, WorkflowError } from '@relay-harness/rlh-workflow'
import type {
