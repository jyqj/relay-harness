/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-ralph`.
 * @module @relay-harness/rlh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-ralph'
