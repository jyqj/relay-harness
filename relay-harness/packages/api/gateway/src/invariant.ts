/**
 * Package-owned invariant companion for `@relay-harness/rlh-api-gateway`.
 * @module @relay-harness/rlh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-api-gateway'
