/**
 * Package-owned invariant companion for `@relay-harness/rlh-headless`.
 * @module @relay-harness/rlh-headless/invariant
 */

import type { Context } from '@relay-harness/cordis'
import type { InvariantInstaller } from '@relay-harness/rlh-invariants'

const PACKAGE_NAME = '@relay-harness/rlh-headless'
