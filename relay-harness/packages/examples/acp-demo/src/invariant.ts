/**
 * Package-owned invariant companion for `@relay-harness/rlh-acp-demo`.
 * @module @relay-harness/rlh-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-acp-demo'
