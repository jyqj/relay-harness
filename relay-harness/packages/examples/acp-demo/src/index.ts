 ...
 * ({@link @relay-harness/rlh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @relay-harness/rlh-acp} bridge. The app owns those plugins through one
 ...
 * @module @relay-harness/rlh-acp-demo
 */
...
} from '@relay-harness/rlh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@relay-harness/rlh-session-checkpoint-policy'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning rlh-system-prompt schema does the same), while
