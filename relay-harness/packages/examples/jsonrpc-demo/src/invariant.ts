/**
 * Package-owned invariant companion for `@relay-harness/rlh-sdk-jsonrpc-demo`.
 * @module @relay-harness/rlh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-sdk-jsonrpc-demo'
