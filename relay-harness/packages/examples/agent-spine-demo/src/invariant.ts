/**
 * Package-owned invariant companion for `@relay-harness/rlh-agent-spine-demo`.
 * @module @relay-harness/rlh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-agent-spine-demo'
