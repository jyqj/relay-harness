/**
 * Package-owned invariant companion for `@relay-harness/rlh-invariants`.
 * @module @relay-harness/rlh-invariants/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-invariants'
