/**
 * Package-owned invariant companion for `@relay-harness/rlh-sdk-jsonrpc-server`.
 * @module @relay-harness/rlh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-sdk-jsonrpc-server'
