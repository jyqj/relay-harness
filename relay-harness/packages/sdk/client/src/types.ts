 ...
 *
 * @module @relay-harness/rlh-sdk-client/types
 */
...
export interface HarnessClientOptions {
  /** The runtime executable (the `rlh-jsonrpc-agent` bin, a packaged exe, or `node`). */
  command: string
   ...
   * credential policy (see `scrubbedParentEnv` in `@relay-harness/rlh-subprocess`
...
/** Options for the high-level {@link RelayHarness} wrapper. */
