/**
 * Package-owned invariant companion for `@relay-harness/rlh-sdk-client`.
 * @module @relay-harness/rlh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-sdk-client'
