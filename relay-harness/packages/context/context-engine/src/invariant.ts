...
/**
 * No runtime invariant: contributor registrations are private, atomically updated state; the
 * seam exposes neither an enumerable snapshot nor lifecycle events to compare independently.
 */
