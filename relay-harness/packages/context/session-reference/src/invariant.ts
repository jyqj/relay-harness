/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-reference`.
 * @module @relay-harness/rlh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-reference'
