/**
 * Package-owned invariant companion for `@relay-harness/rlh-file-reference-local`.
 * @module @relay-harness/rlh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-file-reference-local'
