/**
 * Package-owned invariant companion for `@relay-harness/rlh-hooks-codex`.
 * @module @relay-harness/rlh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-hooks-codex'
