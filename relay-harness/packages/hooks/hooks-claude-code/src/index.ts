 ...
 * mapping; shared execution and parsing live in `rlh-hook-protocol`.
 ...
 * @module @relay-harness/rlh-hooks-claude-code
 */
...
// start/end edges.
import type { SubagentRunId } from '@relay-harness/rlh-subagent'
