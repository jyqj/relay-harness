/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-cordis`.
 * @module @relay-harness/rlh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-cordis'
