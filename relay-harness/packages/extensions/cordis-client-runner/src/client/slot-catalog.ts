...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'shell.main\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
  ...
  {
    key: 'conversation.chat.empty',
    kind: 'list',
    scope: 'session',
    summary: 'Optional empty-transcript occupancy: ChatView renders this list only while the ordered flow has no Nodes and the session is not running.',
    doc: 'Optional empty-transcript occupancy: ChatView renders this list only\nwhile the ordered flow has no Nodes and the session is not running.\nZero entries leave the transcript blank (ordinary New Session / coding\nchats). A desktop plugin can fill a contact roster without replacing\nthe view.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.chat.empty\', () => ctx.slots.register(\n      { name: \'conversation.chat.empty\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation SteeringMessageNodeView key \'steering\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-message-edit MessageEditAction id \'edit\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-message-edit MessageEditEditor',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:280',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:240',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:296',
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-prompt-enhancement EnhanceControl id \'prompt-enhancement\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.right\', () => ctx.slots.register(\n      { name: \'conversation.input.right\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:266',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-context-inspector ContextInspectorAction id \'context-inspector\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-product-shell ProductModeRow id \'product-mode\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-code-index-center CodeIndexCenterSection id \'code-index\'',
      'client-ui-memory-center MemoryCenterSection id \'memory\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Resident center-column host.',
    doc: 'Resident center-column host. Its owner declares conversation and shell.page.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-layout MainContent',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.main\', () => ctx.slots.register(\n      { name: \'shell.main\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:41',
  },
  {
    key: 'shell.overlay',
    kind: 'list',
  ...
  },
  {
    ...
    kind: 'keyed',
    scope: 'root',
    summary: 'Full central page contributed by a product plugin, never a sidebar region.',
    doc: 'Full central page contributed by a product plugin, never a sidebar region.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: library, record, work',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'shell.main\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-product-shell WorkPage key \'work\'',
      'client-ui-product-shell LibraryPage key \'library\'',
      'client-ui-product-shell RecordPage key \'record\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.page\', () => ctx.slots.register(\n      { name: \'shell.page\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:43',
  },
  {
    key: 'shell.terminalDrawer',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Terminal drawer track under the conversation column only.',
    doc: 'Terminal drawer track under the conversation column only. Height 0 when\nclosed keeps the subtree mounted. Session-optional: the occupant owns\nboth the no-session and live-session states without changing identity.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-user-terminal TerminalDrawer',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.chat.label',
    kind: 'single',
    scope: 'root',
    summary: 'Product-level label for the built-in session browser tab.',
    doc: 'Product-level label for the built-in session browser tab.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Primary product navigation; does not replace workspace/session browsing.',
    doc: 'Primary product navigation; does not replace workspace/session browsing.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-product-shell ProductNavigation id \'product\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Running-agents occupant.',
    doc: 'Running-agents occupant. ui-agents-panel injects here.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Browser / preview occupant.',
    doc: 'Browser / preview occupant. ui-preview injects here.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Git diff occupant.',
    doc: 'Git diff occupant. ui-diff injects here.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Single-file preview occupant.',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Workspace files occupant.',
    doc: 'Workspace files occupant. ui-files injects here.',
    registerOptions: [],
    ownerProps: [
      '/** Owner props the Files occupant receives so it can open a file surface. */\nexport interface FilesOwnerProps {\n  openFile: (relativePath: string) => void\n}',
    ],
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Terminal occupant.',
    doc: 'Terminal occupant. ui-user-terminal already injects here; kind and\nscope must stay `single` + `session-maybe` so that inject attaches.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Execution relationships in the current Work main page.',
    doc: 'Execution relationships in the current Work main page.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'shell.page\' (client-ui-product-shell), so it exists while that entry is mounted',
    occupants: [
      'client-ui-product-shell WorkActivity',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'work.activity\', () => ctx.slots.register(\n      { name: \'work.activity\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-product-shell/src/client/index.ts:25',
  },
]
/* jscpd:ignore-end */
