/**
 * Package-owned invariant companion for `@relay-harness/rlh-cordis-client-runner`.
 * @module @relay-harness/rlh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-cordis-client-runner'
