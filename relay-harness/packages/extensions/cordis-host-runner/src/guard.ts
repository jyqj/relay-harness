 ...
 * @module @relay-harness/rlh-cordis-host-runner/guard
 */

import { Context } from '@relay-harness/cordis'
import type { Plugin } from '@relay-harness/cordis'
import { scopeOf } from '@relay-harness/rlh-scope'
import { assertSupportedJsonSchema, defineTool } from '@relay-harness/rlh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@relay-harness/rlh-cordis-client-runner`, whose CTX_VERBS names this one its
