/**
 * Package-owned invariant companion for `@relay-harness/rlh-cordis-host-runner`.
 * @module @relay-harness/rlh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-cordis-host-runner'
