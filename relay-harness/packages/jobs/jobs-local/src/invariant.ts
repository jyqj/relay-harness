/**
 * Package-owned invariant companion for `@relay-harness/rlh-jobs-local`.
 * @module @relay-harness/rlh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-jobs-local'
...
/**
 * No runtime invariant: `@relay-harness/rlh-jobs/invariant` owns per-snapshot identity, status,
