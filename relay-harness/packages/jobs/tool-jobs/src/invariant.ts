/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-jobs`.
 * @module @relay-harness/rlh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-jobs'
