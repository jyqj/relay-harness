/** Package-owned session-event invariants for sandbox policy. @module @relay-harness/rlh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@relay-harness/rlh-sandbox-policy'
