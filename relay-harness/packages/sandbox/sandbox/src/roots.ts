 ...
 * (`@relay-harness/rlh-sandbox-local`) and the in-process filesystem fence
 * (`@relay-harness/rlh-fs-sandbox`) both derive their allow-list here, so "the
