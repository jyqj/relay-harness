/**
 * Package-owned invariant companion for `@relay-harness/rlh-agent-presets`.
 * @module @relay-harness/rlh-agent-presets/invariant
 */

import type { Context } from '@relay-harness/cordis'
import type { InvariantInstaller } from '@relay-harness/rlh-invariants'
// Type-only: resolves the `system-prompt/assemble` waterfall this companion
// joins, and the `agent` field `rlh-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@relay-harness/rlh-agent-presets'

const PACKAGE_NAME = '@relay-harness/rlh-agent-presets'
