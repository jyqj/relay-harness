 ...
 * @module @relay-harness/rlh-agent-presets/discovery
 */
...
import { expandHomePath } from '@relay-harness/rlh-home-paths'
 ...
 *
 * This package owns the writable root the way `rlh-skill-filesystem` owns
 * `<rlhHome>/skills`. An app must assemble the SHIPPED root, whose path only
