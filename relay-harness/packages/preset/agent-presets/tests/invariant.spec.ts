...
import AgentRegistry, { assembleContextFor } from '@relay-harness/rlh-agent'
import AgentLoop from '@relay-harness/rlh-agent-loop'
import InvariantRegistry from '@relay-harness/rlh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@relay-harness/rlh-agent-presets'
import * as AgentPresetsInvariant from '@relay-harness/rlh-agent-presets/invariant'
...
describe('agent-presets invariants', () => {
  ...
  it('admits a joined agent, a scopeless read, and a standing-key read', async () => {
    ...
    const lease = await ctx.agentPresets.acquireStandingScope('standard')
    const standing = lease.key
