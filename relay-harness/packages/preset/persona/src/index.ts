 ...
 *
 * `rlh-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `rlh-subagent` installs; mounted globally
 ...
 * @module @relay-harness/rlh-persona
 */
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@relay-harness/rlh-system-prompt'
