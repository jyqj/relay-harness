/**
 * Package-owned invariant companion for `@relay-harness/rlh-subprocess-e2b`.
 * @module @relay-harness/rlh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-subprocess-e2b'
