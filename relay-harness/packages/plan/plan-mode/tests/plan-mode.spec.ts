...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@relay-harness/rlh-tools'
import { Session, SessionId, type UserMessage } from '@relay-harness/rlh-session'
import AgentRegistry, { agentEvents, type Agent } from '@relay-harness/rlh-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@relay-harness/rlh-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `rlh-plan-mode` beside real `SystemPrompt` and
