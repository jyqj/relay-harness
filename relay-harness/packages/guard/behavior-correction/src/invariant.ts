...
/**
 * No runtime invariant: the detection is a pure function of the session log at the
 * stop boundary, and the only package-local state (per-agent correction counters in
 * a WeakMap) is observable by no independent event or data relation.
 */
