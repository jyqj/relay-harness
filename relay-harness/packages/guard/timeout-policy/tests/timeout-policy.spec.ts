/**
 * Unit + real-load-path coverage for @relay-harness/rlh-tool-call-timeout-policy. The
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@relay-harness/rlh-tools'
import * as timeoutPolicy from '@relay-harness/rlh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@relay-harness/rlh-tool-call-timeout-policy'
...
describe('rlh-tool-call-timeout-policy real-load-path guard', () => {
