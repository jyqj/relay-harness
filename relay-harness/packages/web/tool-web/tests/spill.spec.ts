 ...
 * (`rlh-spill-local` backend + `rlh-spill-policy`), exercised through
...
import LocalSpillStore from '@relay-harness/rlh-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'rlh-spill-web-'))
