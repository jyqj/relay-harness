/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-web`.
 * @module @relay-harness/rlh-tool-web/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-web'
