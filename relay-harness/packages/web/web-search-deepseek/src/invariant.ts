/**
 * Package-owned invariant companion for `@relay-harness/rlh-web-search-deepseek`.
 * @module @relay-harness/rlh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-web-search-deepseek'
