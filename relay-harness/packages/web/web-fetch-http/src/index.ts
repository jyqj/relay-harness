/**
 * `@relay-harness/rlh-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @relay-harness/rlh-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'relay-harness/0.0.1 (+https://github.com/deepseek-ai)'
