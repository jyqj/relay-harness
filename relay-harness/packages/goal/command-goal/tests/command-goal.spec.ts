...
import type { GoalRef } from '@relay-harness/rlh-goal'
import SessionStore, { Session, SessionId } from '@relay-harness/rlh-session'
import * as commandGoal from '@relay-harness/rlh-command-goal'
...
describe('@relay-harness/rlh-command-goal registration', () => {
