/** Package-owned goal-round prompt invariants. @module @relay-harness/rlh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@relay-harness/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@relay-harness/rlh-goal'
...
const PACKAGE_NAME = '@relay-harness/rlh-goal-round-driver'
