...
import * as GoalSessionInvariant from '@relay-harness/rlh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@relay-harness/rlh-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@relay-harness/rlh-goal-round-driver',
    }))
  })
