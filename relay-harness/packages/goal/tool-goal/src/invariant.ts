/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-goal`.
 * @module @relay-harness/rlh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-goal'
