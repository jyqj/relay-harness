 ...
 * @module @relay-harness/rlh-tool-goal
 */

import type { Context } from '@relay-harness/cordis'
import z from '@relay-harness/schemastery'
import { GoalId } from '@relay-harness/rlh-goal'
import type { GoalRef, GoalView } from '@relay-harness/rlh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@relay-harness/rlh-llm'
import { defineTool } from '@relay-harness/rlh-tools'
import type { GenericCallView } from '@relay-harness/rlh-tools'
