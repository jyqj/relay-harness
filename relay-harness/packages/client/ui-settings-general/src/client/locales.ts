...
export const zh = {
  ...
  'simpleMode.title': '精简模式',
  'simpleMode.description': '只保留与智能体对话所需的界面：菜单栏与托盘中隐藏插件市场、MCP 与技能入口。',
  'simpleMode.restart': '重启桌面应用后菜单才会更新。',
  'simpleMode.error': '设置读取或保存失败：{message}',
  ...
  'about.app': 'Relay-Harness-Desktop',
  'about.appMeta': 'github.com/jyqj/relay-harness',
  ...
  'about.updateUnavailable': '此构建不支持自动更新：{message}',
...
export const en = {
  ...
  'simpleMode.description': 'Keep only what a conversation with the agent needs: the plugin market, MCP and skills entries leave the menu bar and the tray.',
  'simpleMode.restart': 'The menus update the next time the desktop app starts.',
  'simpleMode.error': 'Failed to read or save settings: {message}',
  ...
  'about.updateUnavailable': 'Automatic updates are unavailable for this build: {message}',
