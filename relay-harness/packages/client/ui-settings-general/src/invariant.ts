/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-settings-general`.
 * @module @relay-harness/rlh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-settings-general'
