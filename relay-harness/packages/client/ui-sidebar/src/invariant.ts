/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-sidebar`.
 * @module @relay-harness/rlh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-sidebar'
