...
import { SlotTestRuntime, usePinnedBrowserLanguages } from '@relay-harness/rlh-client-test-runtime'
...
beforeEach(() => { vi.stubEnv('RLH_CLIENT_COMMIT_HASH', 'abc1234') })
...
async function bench(options: { locale?: 'en' } = {}) {
  ...
  runtime.provide('layout', { toggleSidebar: vi.fn(), openMain: vi.fn() })
