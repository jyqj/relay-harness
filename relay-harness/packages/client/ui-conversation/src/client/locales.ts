...
export const zh = {
  ...
  'draft.discarded': '上次会话关闭时有未发送的输入，已保留为失效草稿',
  'draft.restore': '恢复到输入框',
  'draft.discard': '丢弃',
  ...
  'hero.suggest.aria': '建议起点',
  'hero.suggest.resume': '继续上次的工作',
  'hero.suggest.resume.draft': '继续上次的工作：先回顾当前进展，再接着完成剩余的部分。',
  'hero.suggest.build': '在新工作区开发',
  'hero.suggest.build.draft': '我想在这个工作区新增一个功能。先调研相关代码并给出实现方案，我确认后再动手。',
  'hero.suggest.summarize': '总结当前进展',
  'hero.suggest.summarize.draft': '总结当前工作区的进展：最近的改动、未完成的事项，以及建议的下一步。',
  'hero.suggest.review': '审查工作区改动',
  'hero.suggest.review.draft': '审查当前工作区未提交的改动，指出缺陷和风险，并按严重程度排序。',
  ...
  'chat.loadOlder': '加载更早',
  'chat.showEarlier': '显示更早 {n} 行',
  'chat.fullHistory': '完整已加载历史（查找／选择）',
  'chat.windowedHistory': '返回窗口模式',
  'chat.fullHistoryHint': '查找仅覆盖已加载历史；可继续加载更早内容。',
  'chat.retainedRows': '保留 {n} 个展开、选中或聚焦项目',
  'chat.toBottom': '回到底部',
  'chat.turnStatus.working': '深潜中…',
...
export const en = {
  ...
  'draft.discarded': 'Unsent input from the previous session was kept as a discarded draft',
  'draft.restore': 'Restore to composer',
  ...
  'hero.suggest.aria': 'Starter suggestions',
  'hero.suggest.resume': 'Resume your last task',
  'hero.suggest.resume.draft': 'Resume the last task: review the current progress first, then finish what remains.',
  'hero.suggest.build': 'Build something new',
  'hero.suggest.build.draft': 'I want to add a new feature in this workspace. Survey the relevant code and propose a plan first; start implementing after I confirm.',
  'hero.suggest.summarize': 'Summarize progress',
  'hero.suggest.summarize.draft': 'Summarize the progress in this workspace: recent changes, open items, and the recommended next step.',
  'hero.suggest.review': 'Review workspace changes',
  'hero.suggest.review.draft': 'Review the uncommitted changes in this workspace; flag defects and risks, ordered by severity.',
  ...
  'chat.showEarlier': 'Show {n} earlier rows',
  'chat.fullHistory': 'Full loaded history (find/select)',
  'chat.windowedHistory': 'Return to windowed history',
  'chat.fullHistoryHint': 'Find covers loaded history only; load earlier to include more.',
  'chat.retainedRows': 'Keeping {n} expanded, selected, or focused items',
  'chat.toBottom': 'Back to bottom',
  'chat.turnStatus.working': 'Deep diving...',
