/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-conversation`.
 * @module @relay-harness/rlh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-conversation'
