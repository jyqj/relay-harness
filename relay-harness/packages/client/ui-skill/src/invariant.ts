/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-skill`.
 * @module @relay-harness/rlh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-skill'
