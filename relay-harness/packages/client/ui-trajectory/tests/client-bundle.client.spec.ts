 ...
 * not built (`pnpm --filter @relay-harness/rlh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@relay-harness/rlh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@relay-harness/rlh-client-runtime/client', await import('@relay-harness/rlh-client-runtime/client')],
      ['@relay-harness/rlh-client-ui-primitives', await import('@relay-harness/rlh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@relay-harness/rlh-client-locale/client')
