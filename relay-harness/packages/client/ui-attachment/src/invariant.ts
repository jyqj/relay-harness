/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-attachment`.
 * @module @relay-harness/rlh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-attachment'
