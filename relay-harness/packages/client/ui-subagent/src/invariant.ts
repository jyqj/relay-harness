/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-subagent`.
 * @module @relay-harness/rlh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-subagent'
