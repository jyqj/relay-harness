...
import type { JobView } from '@relay-harness/rlh-client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@relay-harness/rlh-client-ui-primitives'
import type { PropsLocale, PropsRuntime, TranslateNS } from '@relay-harness/rlh-client-ui-slots'
