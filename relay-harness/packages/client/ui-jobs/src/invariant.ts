/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-jobs`.
 * @module @relay-harness/rlh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-jobs'
