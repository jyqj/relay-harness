...
import * as PluginConfigInvariant from '@relay-harness/rlh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@relay-harness/rlh-client-ui-settings-plugins')
