/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-settings-plugins`.
 * @module @relay-harness/rlh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-settings-plugins'
