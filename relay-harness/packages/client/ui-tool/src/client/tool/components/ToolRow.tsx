...
import type { WebBlockProps } from '@relay-harness/rlh-client-ui-primitives'
import type { TranslateNS } from '@relay-harness/rlh-client-ui-slots'
 ...
 *  the running rail (CSS on data-state) carries the in-flight signal. */
...
/** Visually hidden run-state label: the StateDot and the running rail are both
...
export function ToolRow({
  ...
  // The run-state label AT needs: the StateDot and the running rail are both
