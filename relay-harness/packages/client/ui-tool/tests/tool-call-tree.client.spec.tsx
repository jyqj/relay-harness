...
import type { ConversationSnapshot, ToolResultNode } from '@relay-harness/rlh-client-runtime/client'
...
describe('ToolCallTree', () => {
  ...
  it('abbreviates a POSIX home path in the generic tool summary', () => {
    ...
    const view = render(<ToolCallTree {...props(block, 'w1', {
      version: '0', cwd: '/tmp', attachedSessions: 0, home: '/h', canOpenPath: false, scratchCwd: '/scratch',
    })} />)
