...
import * as ModelsInvariant from '@relay-harness/rlh-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@relay-harness/rlh-client-ui-settings-models')
    apply()
