/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-reference`.
 * @module @relay-harness/rlh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-reference'
