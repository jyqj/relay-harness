/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-primitives`.
 * @module @relay-harness/rlh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-primitives'
