/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-goal`.
 * @module @relay-harness/rlh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-goal'
