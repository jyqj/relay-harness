...
import type { GoalSnapshot } from '@relay-harness/rlh-goal/client'
import {
...
export type GoalDockProps = import('@relay-harness/rlh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
