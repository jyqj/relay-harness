...
import { ConversationNodeAssembler } from '@relay-harness/rlh-client-runtime/client'
...
import { commandDefinition } from '@relay-harness/rlh-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@relay-harness/rlh-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
