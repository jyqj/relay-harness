...
import { SlotRegistry, type SessionId } from '@relay-harness/rlh-client-runtime/client'
import { ConversationEventRegistry } from '@relay-harness/rlh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@relay-harness/rlh-goal/client'
