/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-connection`.
 * @module @relay-harness/rlh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-connection'
