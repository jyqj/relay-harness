...
import * as AgentPresetInvariant from '@relay-harness/rlh-client-ui-agent-preset/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@relay-harness/rlh-client-ui-agent-preset')
