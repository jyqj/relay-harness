 ...
 * @module @relay-harness/rlh-client-web/src/loader-status
 */
import type { FiberState } from '@relay-harness/cordis'
 ...
 * while retaining its type (same rationale as rlh-tool-cordis's mirror).
 */
