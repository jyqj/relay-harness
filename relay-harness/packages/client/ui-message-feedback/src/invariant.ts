/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-message-feedback`.
 * @module @relay-harness/rlh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-message-feedback'
