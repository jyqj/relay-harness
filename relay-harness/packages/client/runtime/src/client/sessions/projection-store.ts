...
// (`/types`, zero imports), never the package root: the root's rlh-agent →
// rlh-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@relay-harness/rlh-session-projection/types'
