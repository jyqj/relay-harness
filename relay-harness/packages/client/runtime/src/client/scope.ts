 ...
 * Agent's identity. The mechanism mirrors the host `rlh-scope` architecture
...
import { Context as CordisContext } from '@relay-harness/cordis'
import type { SessionId } from '@relay-harness/rlh-api-remotes/client'
import type { TypertClientRemote,TypertRemoteScopeApi } from '@relay-harness/rlh-typert-protocol'
...
const kScope = Symbol('rlh.client.scope')
