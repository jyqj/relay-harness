/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-commands`.
 * @module @relay-harness/rlh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-commands'
