/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-hmr`.
 * @module @relay-harness/rlh-client-hmr/invariant
 */

import type { Context, Fiber } from '@relay-harness/cordis'
import type { InvariantInstaller } from '@relay-harness/rlh-invariants'

const PACKAGE_NAME = '@relay-harness/rlh-client-hmr'
