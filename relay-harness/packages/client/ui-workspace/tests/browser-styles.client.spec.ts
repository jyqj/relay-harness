...
const css = readFileSync(fileURLToPath(new URL('../src/client/browser/WorkspaceBrowser.module.css', import.meta.url)), 'utf8')
const rowsCss = readFileSync(fileURLToPath(new URL('../src/client/browser/rows/Rows.module.css', import.meta.url)), 'utf8')
