/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-permission-presets`.
 * @module @relay-harness/rlh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-permission-presets'
