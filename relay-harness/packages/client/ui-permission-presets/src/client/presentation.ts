 ...
 * @returns the explicit Developer Mode product label or the conventional display name.
 */
export function displayPermissionPreset(value: string, name: string): string {
  return value === FULL_ACCESS_PRESET ? 'Developer Mode' : displayPresetName(name)
}
