/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-settings`.
 * @module @relay-harness/rlh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-settings'
