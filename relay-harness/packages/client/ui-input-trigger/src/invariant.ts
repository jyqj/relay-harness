/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-input-trigger`.
 * @module @relay-harness/rlh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-input-trigger'
