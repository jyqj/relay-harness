 ...
 * @module @relay-harness/rlh-agent-loop/invariant
 */

import type { Context } from '@relay-harness/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@relay-harness/rlh-llm'
import type { InvariantFailure, InvariantInstaller } from '@relay-harness/rlh-invariants'
import { foldRequestHeader } from '@relay-harness/rlh-session'

const PACKAGE_NAME = '@relay-harness/rlh-agent-loop'
