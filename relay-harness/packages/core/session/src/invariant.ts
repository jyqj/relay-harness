 ...
 * companion beside `@relay-harness/rlh-invariants` to enable the checks.
 *
 * @module @relay-harness/rlh-session/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session'
