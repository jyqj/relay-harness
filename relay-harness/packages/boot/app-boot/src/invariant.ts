/**
 * Package-owned invariant companion for `@relay-harness/rlh-app-boot`.
 * @module @relay-harness/rlh-app-boot/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-app-boot'
