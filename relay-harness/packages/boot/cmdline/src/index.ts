/**
 * @relay-harness/rlh-cmdline — the command line a rlh launcher hands to the app
 * it boots.
 *
 ...
 * @module @relay-harness/rlh-cmdline
 */
 ...
 * verbatim and in argv order. `rlh --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
