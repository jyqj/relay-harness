/**
 * Package-owned invariant companion for `@relay-harness/rlh-storage-domain`: every
 ...
 * @module @relay-harness/rlh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-storage-domain'
