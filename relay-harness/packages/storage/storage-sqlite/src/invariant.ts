/**
 * Package-owned invariant companion for `@relay-harness/rlh-storage-sqlite`.
 * @module @relay-harness/rlh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-storage-sqlite'
