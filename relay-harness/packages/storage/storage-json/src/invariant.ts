/**
 * Package-owned invariant companion for `@relay-harness/rlh-storage-json`.
 * @module @relay-harness/rlh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-storage-json'
