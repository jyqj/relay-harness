/**
 * Package-owned invariant companion for `@relay-harness/rlh-typert-protocol`.
 * @module @relay-harness/rlh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-typert-protocol'
