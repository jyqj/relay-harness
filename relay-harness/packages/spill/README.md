...
| [`spill-local/`](spill-local/README.md) | Stores spilled text in session-scoped local files; reclaims them at session disposal and sweeps orphan roots at startup | registers on `ctx.spillStore` |
