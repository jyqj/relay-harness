...
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@relay-harness/rlh-spill-local'

let root: string

beforeEach(() => {
  root = mkdtempSync(join(tmpdir(), 'rlh-spill-test-'))
})
afterEach(() => {
