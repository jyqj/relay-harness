/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-test-runtime`.
 * @module @relay-harness/rlh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-test-runtime'
