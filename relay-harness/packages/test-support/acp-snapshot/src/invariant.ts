/**
 * Package-owned invariant companion for `@relay-harness/rlh-acp-snapshot`.
 * @module @relay-harness/rlh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-acp-snapshot'
