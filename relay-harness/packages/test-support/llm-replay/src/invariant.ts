/**
 * Package-owned invariant companion for `@relay-harness/rlh-llm-replay`.
 * @module @relay-harness/rlh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-llm-replay'
