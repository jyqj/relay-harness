...
function checkManifest(
  ...
  if (owner.packageName === '@relay-harness/rlh-invariants') return
  if (manifest.peerDependencies?.['@relay-harness/rlh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@relay-harness/rlh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@relay-harness/rlh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@relay-harness/rlh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@relay-harness/rlh-invariants'
