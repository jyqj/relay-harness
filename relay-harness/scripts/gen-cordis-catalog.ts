...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@relay-harness/rlh-typert-generator'
import type { CordisCatalogPolicy } from '@relay-harness/rlh-typert-generator'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  agents: 'core.md',
  apiProxy: 'typert.md',
  hostInteractions: 'typert.md',
  workResults: 'work-results.md',
  ...
  sessionHistoryContext: 'context-engine.md',
  fs: 'filesystem.md',
  goals: 'goal.md',
  issueOrchestration: 'issue-automation.md',
  issueRunner: 'issue-automation.md',
  issueWorkflow: 'issue-automation.md',
  issueWorkspace: 'issue-automation.md',
  webServer: 'web-server.md',
  invariants: 'invariants.md',
  llm: 'llm-streaming.md',
  longTermMemory: 'memory.md',
  memoryConflictDetector: 'memory.md',
  memoryOutcomeReconciler: 'memory.md',
  memoryExtractionQueue: 'memory.md',
  lsp: 'lsp.md',
  mcpServersFile: 'extensions.md',
  mcpCatalog: 'extensions.md',
  messageFeedback: 'feedback.md',
  permissionPresets: 'permission-presets.md',
  productMode: 'settings.md',
  planMode: 'plan.md',
  promptEnhancement: 'prompt-enhancement.md',
  ...
  skills: 'skills.md',
  spillStore: 'spill.md',
  codeIndex: 'code-index.md',
  codeContext: 'code-index.md',
  storage: 'storage.md',
 ...
 * The scan that enforces this list reads EVERY `declare module '@relay-harness/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  rlhHomePath: 'not a service: boot-provided root accessor function (typeof rlhHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
  ...
  settingsNavigation: 'client-side Settings section navigation service — packages/client/ui-settings-general/README.md owns the API',
  ...
  productShell: 'client-side persisted product-mode projection service — packages/client/ui-product-shell/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'credentials': 'credentials.md',
  'issue-orchestration': 'issue-automation.md',
  'issue-workflow': 'issue-automation.md',
  'domain': 'storage.md',
  'fs': 'filesystem.md',
  'goal': 'goal.md',
  'llm': 'llm-streaming.md',
  'message-feedback': 'feedback.md',
  'session': 'session.md',
  'settings': 'settings.md',
  'tracker': 'issue-automation.md',
  'skills': 'skills.md',
 ...
 * scan reads EVERY `declare module '@relay-harness/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  IndexStatusReport: 'code-index.md',
  HydrateChunksRequest: 'code-index.md',
  HydrateChunksResult: 'code-index.md',
  RefreshOptions: 'code-index.md',
  RefreshSummary: 'code-index.md',
  SearchRequest: 'code-index.md',
  SearchResult: 'code-index.md',
  CodeIndexWorkspace: 'code-index.md',
  GraphEnrichLimits: 'code-index.md',
  GraphExploreRequest: 'code-index.md',
  GraphExploreResult: 'code-index.md',
  Message: 'llm-streaming.md',
  MessageSource: 'llm-streaming.md',
  AbortMemoryTurnInput: 'memory.md',
  CommitMemoryTurnInput: 'memory.md',
  ForgetMemoryInput: 'memory.md',
  FindMemoryConflictsInput: 'memory.md',
  DetectMemoryConflictsInput: 'memory.md',
  ListMemoryInput: 'memory.md',
  MemoryEntry: 'memory.md',
  MemoryConflictCandidate: 'memory.md',
  MemoryListPage: 'memory.md',
  MemoryOutcome: 'memory.md',
  MemorySignal: 'memory.md',
  MemoryExtractionJob: 'memory.md',
  MemoryExtractionJobId: 'memory.md',
  MemoryExtractionResult: 'memory.md',
  MemoryExtractionSource: 'memory.md',
  MemoryExtractionRoute: 'memory.md',
  MemoryId: 'memory.md',
  MemoryScope: 'memory.md',
  MemorySearchHit: 'memory.md',
  MemoryTurnHandle: 'memory.md',
  PrepareMemoryTurnInput: 'memory.md',
  PreparedMemoryTurn: 'memory.md',
  RememberMemoryInput: 'memory.md',
  ReviseMemoryInput: 'memory.md',
  ReconcileMemoryOutcomesInput: 'memory.md',
  ListMemoryOutcomesInput: 'memory.md',
  SearchMemoryInput: 'memory.md',
  ClaimMemoryExtractionInput: 'memory.md',
  CompleteMemoryExtractionInput: 'memory.md',
  EnqueueMemoryExtractionInput: 'memory.md',
  FailMemoryExtractionInput: 'memory.md',
  MessageFeedbackDeleteRequest: 'feedback.md',
  MessageFeedbackChanged: 'feedback.md',
  ...
  Evidence: 'context-engine.md',
  EvidenceFreshness: 'context-engine.md',
  EvidenceId: 'context-engine.md',
  EvidenceVerification: 'context-engine.md',
  NegativeFinding: 'context-engine.md',
  PreparedStepContext: 'context-engine.md',
  PreparedPromptEnhancementContext: 'prompt-enhancement.md',
  PromptEnhancementContextProvider: 'prompt-enhancement.md',
  PromptEnhancementContextRequest: 'prompt-enhancement.md',
  PromptEnhancementFailure: 'prompt-enhancement.md',
  PromptEnhancementModelProvenance: 'prompt-enhancement.md',
  PromptEnhancementOutcome: 'prompt-enhancement.md',
  PromptEnhancementProvider: 'prompt-enhancement.md',
  PromptEnhancementProviderRequest: 'prompt-enhancement.md',
  PromptEnhancementProviderResult: 'prompt-enhancement.md',
  PromptEnhancementResult: 'prompt-enhancement.md',
  PromptEnhancementService: 'prompt-enhancement.md',
  McpServerCatalogGeneration: 'extensions.md',
  McpResourceDescriptor: 'extensions.md',
  McpResourceTemplateDescriptor: 'extensions.md',
  McpPromptDescriptor: 'extensions.md',
  McpResourceRead: 'extensions.md',
  McpPromptResult: 'extensions.md',
  ProviderExplain: 'context-engine.md',
  ProviderGeneration: 'context-engine.md',
  ProviderHealthState: 'context-engine.md',
  ResourceRef: 'context-engine.md',
  SourceId: 'context-engine.md',
  ContextContributorDescription: 'context-engine.md',
  ContextRetrievalInput: 'context-engine.md',
  StepContextContributor: 'context-engine.md',
  StepContextInput: 'context-engine.md',
  ...
  SessionPersistenceFence: 'persistence.md',
  PresetScopeLease: 'core.md',
  DeliverablesProjection: 'work-results.md',
  WorkAcceptanceProjection: 'work-results.md',
  WorkVerifiedReview: 'work-results.md',
  WorkAcceptRequest: 'work-results.md',
  WorkAcceptReceipt: 'work-results.md',
  WorkLibraryRevision: 'work-results.md',
  WorkLibraryRequest: 'work-results.md',
  WorkLibraryEntry: 'work-results.md',
  WorkLibraryPage: 'work-results.md',
  WorkOpenRequest: 'work-results.md',
  WorkReadRequest: 'work-results.md',
  WorkView: 'work-results.md',
  WorkHistoryPage: 'work-results.md',
  WorkHistoryRequest: 'work-results.md',
  WorkContentReview: 'work-results.md',
  WorkContentReviewRead: 'work-results.md',
  WorkContentReviewRequest: 'work-results.md',
  ...
  WorkflowActiveRunSnapshot: 'workflow.md',
  IssueCommand: 'issue-automation.md',
  IssueOrchestrationEntry: 'issue-automation.md',
  IssueOrchestrationSnapshot: 'issue-automation.md',
  IssueRefreshResult: 'issue-automation.md',
  IssueRun: 'issue-automation.md',
  IssueRunRequest: 'issue-automation.md',
  IssueWorkflowSnapshot: 'issue-automation.md',
  IssueWorkspace: 'issue-automation.md',
  TrackerIssue: 'issue-automation.md',
  TrackerProvider: 'issue-automation.md',
  TrackerToolBinding: 'issue-automation.md',
  ...
  ProductModeSnapshot: 'settings.md',
  ProductModeSetRequest: 'settings.md',
