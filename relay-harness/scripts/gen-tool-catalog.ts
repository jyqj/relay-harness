...
import SqliteSessionQueryEngine from '@relay-harness/rlh-session-query-sqlite'
import GoalService from '@relay-harness/rlh-goal'
...
import { PwshLocalExecutor } from '@relay-harness/rlh-pwsh-local'
...
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@relay-harness/rlh-attachment'
import UserQuestionService from '@relay-harness/rlh-user-questions'
import PlanModeController from '@relay-harness/rlh-plan-mode'
import WebRuntime from '@relay-harness/rlh-web'
import * as WebSearchExa from '@relay-harness/rlh-web-search-exa'
import * as WebFetchLocal from '@relay-harness/rlh-web-fetch-http'
import SubagentRuntime from '@relay-harness/rlh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@relay-harness/rlh-subagent'
import * as ToolSubagentControl from '@relay-harness/rlh-tool-subagent-control'
import * as ToolSubagentListAgents from '@relay-harness/rlh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@relay-harness/rlh-tool-subagent-report'
...
import * as ToolAskUser from '@relay-harness/rlh-tool-ask-user'
...
import * as ToolSchedule from '@relay-harness/rlh-schedule'
import Lsp from '@relay-harness/rlh-lsp'
import * as ToolLsp from '@relay-harness/rlh-tool-lsp'
...
import * as ToolSessionQuery from '@relay-harness/rlh-tool-session-query'
import * as ToolTasks from '@relay-harness/rlh-tool-jobs'
import type TeamService from '@relay-harness/rlh-experimental-agent-team'
import * as ToolTeam from '@relay-harness/rlh-experimental-tool-agent-team'
import * as ToolTodo from '@relay-harness/rlh-tool-todo'
import * as ToolSubagent from '@relay-harness/rlh-tool-subagent'
import * as ToolWeb from '@relay-harness/rlh-tool-web'
import VmWorkflowEngine from '@relay-harness/rlh-workflow-worker-thread'
import * as ToolRalph from '@relay-harness/rlh-tool-ralph'
import * as ToolWorkflow from '@relay-harness/rlh-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@relay-harness/rlh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@relay-harness/rlh-plan-mode',
    dir: 'plan-mode',
  ...
  {
    pkg: '@relay-harness/rlh-tool-bash',
    dir: 'tool-bash',
  ...
  {
    pkg: '@relay-harness/rlh-tool-pwsh',
    dir: 'tool-pwsh',
  ...
  {
    pkg: '@relay-harness/rlh-tool-bash-persistent',
  ...
  {
    pkg: '@relay-harness/rlh-tool-pwsh-persistent',
  ...
  {
    pkg: '@relay-harness/rlh-tool-str-replace-editor',
  ...
  {
    pkg: '@relay-harness/rlh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@relay-harness/rlh-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@relay-harness/rlh-tool-goal',
    dir: 'tool-goal',
  ...
  {
    pkg: '@relay-harness/rlh-schedule',
    dir: 'schedule',
  ...
  {
    pkg: '@relay-harness/rlh-tool-lsp',
    dir: 'tool-lsp',
  ...
  {
    pkg: '@relay-harness/rlh-tool-memory',
    dir: 'tool-memory',
  ...
  {
    pkg: '@relay-harness/rlh-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@relay-harness/rlh-tool-skill',
    dir: 'tool-skill',
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        rlhHome: resolve(root, '.tmp/tool-catalog/.rlh'),
  ...
  {
    pkg: '@relay-harness/rlh-tool-session-query',
  ...
  {
    pkg: '@relay-harness/rlh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@relay-harness/rlh-tool-subagent-control',
  ...
  {
    pkg: '@relay-harness/rlh-tool-subagent-report',
  ...
  {
    pkg: '@relay-harness/rlh-tool-jobs',
    dir: 'tool-jobs',
  ...
  {
    pkg: '@relay-harness/rlh-experimental-tool-agent-team',
    dir: 'tool-agent-team',
  ...
  {
    pkg: '@relay-harness/rlh-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@relay-harness/rlh-tool-workflow',
    dir: 'tool-workflow',
  ...
  {
    pkg: '@relay-harness/rlh-tool-web',
    dir: 'tool-web',
