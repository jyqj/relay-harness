...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/shell': { kind: 'indirect', reason: 'The service interface delegates all model rendering to rlh-tool-bash.' },
  'packages/shell/shell-env': { kind: 'indirect', reason: 'The env service exposes managed RLH_* facts through the shell tools (rlh-tool-bash/rlh-tool-pwsh); it registers no prompt or schema of its own.' },
  'packages/shell/bash-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to rlh-tool-bash.' },
  'packages/shell/pwsh-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to rlh-tool-pwsh.' },
  'packages/code-runtime/code-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to Code Mode in rlh-tools.' },
  'packages/core/agent-tool-presentation': { kind: 'indirect', reason: 'The row only selects between the two projections rlh-tools owns; it registers no prompt, schema, or result of its own.' },
  'packages/code-runtime/code-runtime-worker-thread': { kind: 'indirect', reason: 'The worker backend delegates model rendering to Code Mode in rlh-tools.' },
  'packages/code-runtime/code-runtime-python': { kind: 'indirect', reason: 'The CPython subprocess backend delegates model rendering to Code Mode in rlh-tools.' },
  'packages/memory/memory': { kind: 'indirect', reason: 'The service definition delegates model rendering to memory-agent and tool-memory.' },
  'packages/memory/memory-sqlite': { kind: 'none', reason: 'Canonical storage and retrieval provider; Consumers own every model-visible projection.' },
  ...
  'packages/client/ui-session-tree': { kind: 'indirect', reason: 'Browser-side navigation delegates user-initiated continuation and replacement messages to the ordinary Session prompt path.' },
  ...
  'packages/client/ui-jobs': { kind: 'none', reason: 'Browser-side read-only projection of ctx.jobs records; rlh-tool-jobs owns the model-facing behavior.' },
  ...
  'packages/client/ui-plan': { kind: 'indirect', reason: 'The chip dispatches /plan off; rlh-plan-mode owns the model-visible policy, exit tool, and logged state.' },
  'packages/client/ui-user-questions': { kind: 'indirect', reason: 'The package mounts rlh-tool-ask-user; that tool owns the model-visible schema and answer rendering.' },
  ...
  'packages/client/ui-agents-panel': { kind: 'none', reason: 'Browser-side Agents surface; registers nothing model-facing.' },
  'packages/client/ui-diff': { kind: 'none', reason: 'Browser-side Diff surface; registers nothing model-facing.' },
  'packages/client/ui-files': { kind: 'none', reason: 'Browser-side Files surface; registers nothing model-facing.' },
  'packages/client/ui-git': { kind: 'none', reason: 'Browser-side titlebar Git control; registers nothing model-facing.' },
  'packages/client/ui-message-edit': { kind: 'none', reason: 'Browser-side message edit chrome; registers nothing model-facing.' },
  'packages/client/ui-preview': { kind: 'none', reason: 'Browser-side Preview surface; registers nothing model-facing.' },
  'packages/client/ui-surfaces': { kind: 'none', reason: 'Browser-side right-column surface shell; registers nothing model-facing.' },
  'packages/client/ui-titlebar': { kind: 'none', reason: 'Browser-side desktop titlebar chrome; registers nothing model-facing.' },
  'packages/client/ui-user-terminal': { kind: 'none', reason: 'Browser-side terminal drawer; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-remote': { kind: 'none', reason: 'Browser-side desktop pairing Settings page; registers nothing model-facing.' },
  'packages/client/ui-settings-mcp': { kind: 'none', reason: 'Browser-side MCP settings page; registers nothing model-facing.' },
  'packages/client/ui-settings-skills': { kind: 'none', reason: 'Browser-side Skills settings page; registers nothing model-facing.' },
  ...
  'packages/context/context-engine': { kind: 'none', reason: 'The seam sequences and records contributor messages but registers no model-facing prompt, schema, tool, or message of its own.' },
  'packages/index/code-index': { kind: 'indirect', reason: 'The retrieval seam delegates model rendering to the search_code_index/code_index_status/refresh_code_index tools in rlh-tool-code-index.' },
  'packages/index/code-index-search': { kind: 'indirect', reason: 'The ranking engine only feeds ctx.codeIndex.search() results; model-facing request text is owned by the rlh-tool-code-index consumer.' },
  'packages/index/code-index-sqlite': { kind: 'indirect', reason: 'The derived store only persists what the provider writes; the search_code_index/code_index_status tools own every model-visible rendering.' },
  'packages/index/code-index-local': { kind: 'indirect', reason: 'Assembled retrieval answers reach the model only through the code-index tools; prompts and schemas remain theirs.' },
  'packages/index/code-index-parser': { kind: 'indirect', reason: 'The parsing layer only shapes what the derived index stores; the search_code_index/code_index_status tools own every model-visible rendering.' },
  'packages/fs/fs': { kind: 'indirect', reason: 'The service interface delegates model rendering to rlh-tool-fs.' },
  'packages/e2b/fs-e2b': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-fs.' },
  'packages/fs/fs-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-fs.' },
  ...
  'packages/host/mcp-servers': { kind: 'none', reason: 'Host Remote for the MCP settings catalog; registers nothing model-facing.' },
  'packages/host/skill-inventory': { kind: 'none', reason: 'Host Remote for the Skills settings catalog; registers nothing model-facing.' },
  'packages/mcp/mcp-servers-file': { kind: 'none', reason: 'File-backed mcp-client mounter; model-facing tools belong to rlh-mcp-client.' },
  ...
  'packages/lsp/lsp': { kind: 'indirect', reason: 'The provider registry delegates model rendering to rlh-tool-lsp.' },
  'packages/lsp/lsp-stdio': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-lsp.' },
  ...
  'packages/sandbox/sandbox-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-bash-sandbox and rlh-tool-bash.' },
  ...
  'packages/skill/skill': { kind: 'indirect', reason: 'The provider registry delegates model rendering to rlh-tool-skill.' },
  'packages/skill/skill-badge': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to rlh-tool-skill.' },
  'packages/skill/skill-filesystem': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-skill.' },
  ...
  'packages/jobs/jobs-local': { kind: 'indirect', reason: 'The registry backend delegates model rendering to producer plugins and rlh-tool-jobs.' },
  'packages/examples/acp-demo': { kind: 'indirect', reason: 'The app bundle delegates request composition to rlh-agent-spine-demo and rlh-acp.' },
  ...
  'packages/interaction/permission-presets': { kind: 'indirect', reason: 'The service writes mechanism events rendered by rlh-user-approval and rlh-tool-bash.' },
  ...
  'packages/util/sqlite-runtime': { kind: 'none', reason: 'Only loads a Node builtin; storage and tool consumers own all model-visible output.' },
  'packages/web/web': { kind: 'indirect', reason: 'The provider registry delegates model rendering to rlh-tool-web.' },
  'packages/web/web-fetch-http': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-web.' },
  'packages/web/web-search-exa': { kind: 'indirect', reason: 'The provider backend delegates model rendering to rlh-tool-web.' },
