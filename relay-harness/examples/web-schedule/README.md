...
This overlay opts one `rlh web` process into Schedule reminders without changing the shipped default Web composition:

```sh
rlh web --patch examples/web-schedule/cordis.yml
```
