import { Context, Service, type Plugin } from '@relay-harness/cordis'
import type { Dict } from '@relay-harness/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@relay-harness/cordis-plugin-loader'
...
import type {} from '@relay-harness/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [relay-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
