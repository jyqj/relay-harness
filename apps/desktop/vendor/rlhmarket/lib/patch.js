 ...
 *
 * RLH composes a web profile from the bundle layers + the user patch layer
 * (`$RLH_HOME/profiles/<name>/cordis.patch.yml`), with per-key override
 ...
 * target host is the same RLH.
 */
const PROTECTED_MODULE_PATTERNS = [
    /^cordis:/u,
    /^@relay-harness\/cordis-plugin-/u,
    /^@relay-harness\/rlh-host-/u,
    /^@relay-harness\/rlh-client-modules$/u,
    /^@relay-harness\/rlh-client-connection$/u,
    /^@relay-harness\/rlh-client-hmr$/u,
    /^@relay-harness\/rlh-client-runtime$/u,
    /^@relay-harness\/rlh-client-locale$/u,
    /^@relay-harness\/rlh-client-web/u,
    /^@relay-harness\/rlh-web-frontend$/u,
    /^@relay-harness\/rlh-web-app$/u,
    /^@relay-harness\/rlh-settings/u,
    /^@relay-harness\/rlh-credentials/u,
    /^@relay-harness\/rlh-session/u,
    /^@relay-harness\/rlh-storage/u,
    /^@relay-harness\/rlh-typert/u,
    /^@relay-harness\/rlh-api-remotes$/u,
    /^@relay-harness\/rlh-tools$/u,
    /^@relay-harness\/rlh-system-prompt$/u,
    /^@relay-harness\/rlh-agent/u,
    /^@relay-harness\/rlh-llm/u,
    /^@relay-harness\/rlh-persona$/u,
    /^@relay-harness\/rlh-scope$/u,
    /^@relay-harness\/rlh-launch-environment$/u,
    /^@relay-harness\/rlh-shell$/u,
    /^@relay-harness\/rlh-subprocess/u,
    /^@relay-harness\/rlh-fs/u,
    /^@relay-harness\/rlh-sandbox/u,
    /^@relay-harness\/rlh-jobs/u,
    /^@relay-harness\/rlh-skill/u,
    /^@relay-harness\/rlh-goal/u,
    /^@relay-harness\/rlh-workflow/u,
    /^@relay-harness\/rlh-subagent/u,
    /^@relay-harness\/rlh-web$/u,
    /^@relay-harness\/rlh-workspace/u,
    /^@relay-harness\/rlh-user-approval$/u,
    /^@relay-harness\/rlh-user-questions$/u,
    /^@relay-harness\/rlh-commands$/u,
    /^@relay-harness\/rlh-hook/u,
    /^@relay-harness\/rlh-spill/u,
    /^@relay-harness\/rlh-guard/u,
    /^@relay-harness\/rlh-tool-call-timeout-policy$/u,
    /^@relay-harness\/rlh-repeat-tool-reminder$/u,
];
...
export function rowIdsForPackage(host, profileDirectory, packageName) {
    ...
    // rows that merely reconfigure OTHER plugins — rlh-vision-router tunes the
    ...
    // its root without declaring rlh.bundle.patch (the loader probes it too).
 ...
 * OUTSIDE the market (hand-edited cordis.patch.yml, rlh-web-plugin-manager,
 * the rlh CLI), which the market's own state.json never sees.
 */
...
function appendPatchEntry(patchPath, block) {
    ...
    // The rlh profile template ships an empty `[]` placeholder (a valid
    ...
    // The rlh entry-list dialect decides: anything that does not parse as a
 ...
 * comments. That is not a top-level array, and rlh refuses to boot the
