...
flowchart LR
  ...
  plugin_dsh_base_mcp_servers_file["mcp-servers-file<br/>@deepseek-ai/dsh-mcp-servers-file"]
  cfg --> plugin_dsh_base_mcp_servers_file
  ...
  plugin_dsh_base_behavior_correction["behavior-correction<br/>@deepseek-ai/dsh-behavior-correction"]
  cfg --> plugin_dsh_base_behavior_correction
  plugin_dsh_base_token_budget_controller["token-budget-controller<br/>@deepseek-ai/dsh-token-budget-controller"]
  cfg --> plugin_dsh_base_token_budget_controller
...
| `mcp-servers-file` | `@deepseek-ai/dsh-mcp-servers-file` |
...
| `behavior-correction` | `@deepseek-ai/dsh-behavior-correction` |
| `token-budget-controller` | `@deepseek-ai/dsh-token-budget-controller` |
