import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@relay-harness/cordis-plugin-loader'
 ...
 * (`rlh --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`rlh --dump-config`) so a dump can never drift from what boots. The input
