/**
 * Package-owned invariant companion for `@relay-harness/rlh-anonymous-user-id`.
 * @module @relay-harness/rlh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-anonymous-user-id'
