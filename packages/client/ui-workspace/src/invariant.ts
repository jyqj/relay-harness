/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-workspace`.
 * @module @relay-harness/rlh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-workspace'
