/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-model-selection`.
 * @module @relay-harness/rlh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-model-selection'
