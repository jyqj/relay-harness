/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-renderer`.
 * @module @relay-harness/rlh-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-renderer'
