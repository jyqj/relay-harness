...
import { isAppendSurfaceEvent } from '@relay-harness/rlh-client-runtime/client'
import type { MarkdownFileMentions } from '@relay-harness/rlh-client-ui-primitives'
import type { TurnTailOwnerProps } from '@relay-harness/rlh-client-ui-conversation/client'
...
declare module '@relay-harness/rlh-client-runtime/client' {
