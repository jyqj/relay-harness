...
import type { ChatFileMentions, TurnTailOwnerProps } from '@relay-harness/rlh-client-ui-conversation/client'
...
describe('ProducedFiles row', () => {
  ...
  const capability = (
    ...
    const description = canOpenPath === undefined
      ? undefined
      : { version: 'test', cwd: '/workspace', attachedSessions: 1, home: '/h', canOpenPath, scratchCwd: '/scratch' }
    return {
      isLoopback,
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@relay-harness/rlh-client-ui-deliverables'])
