/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-layout`.
 * @module @relay-harness/rlh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-layout'
