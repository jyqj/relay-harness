/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-web`.
 * @module @relay-harness/rlh-client-web/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-web'
