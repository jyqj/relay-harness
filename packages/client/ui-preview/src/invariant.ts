/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-preview`.
 * @module @relay-harness/rlh-client-ui-preview/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-preview'
