/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-slots`.
 * @module @relay-harness/rlh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-slots'
