/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-trajectory`.
 * @module @relay-harness/rlh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-trajectory'
