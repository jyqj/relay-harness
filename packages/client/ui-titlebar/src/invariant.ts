/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-titlebar`.
 * @module @relay-harness/rlh-client-ui-titlebar/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-titlebar'
