/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-agent-preset`.
 * @module @relay-harness/rlh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-agent-preset'
