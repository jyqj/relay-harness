/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-ui-tool`.
 * @module @relay-harness/rlh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-ui-tool'
