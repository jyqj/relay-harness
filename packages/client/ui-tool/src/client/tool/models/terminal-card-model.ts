 ...
 * @module
 */
import { resolveWorkspacePath } from '@relay-harness/rlh-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@relay-harness/rlh-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in rlh-client-runtime), leaving a terminal
