...
import type { ToolCallOwnerProps } from '@relay-harness/rlh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@relay-harness/rlh-client-ui-primitives'
...
const SEARCH_ARGS = '{"query":"relay harness"}'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@relay-harness/cordis').Context
