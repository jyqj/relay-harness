...
export const en = {
  ...
  effortTitle: 'Supported thinking intensity',
  'effort.off': 'Off',
  ...
  'effort.max': 'Max',
  effortOffAlone: 'Off cannot be the only thinking intensity.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  // Thinking intensity level names stay English in every locale (match the composer selector).
  effortTitle: 'Supported thinking intensity',
  'effort.off': 'Off',
  'effort.minimal': 'Minimal',
  'effort.low': 'Low',
