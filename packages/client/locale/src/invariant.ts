/**
 * Package-owned invariant companion for `@relay-harness/rlh-client-locale`.
 * @module @relay-harness/rlh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-client-locale'
