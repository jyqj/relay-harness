...
import type { LocaleSettings, LocaleSnapshot } from '@relay-harness/rlh-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@relay-harness/rlh-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (rlh-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared RLH home agrees', () => {
