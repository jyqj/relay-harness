/**
 * Package-owned invariant companion for `@relay-harness/rlh-agent-tool-presentation`.
 * @module @relay-harness/rlh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-agent-tool-presentation'
 ...
 * registry's to hold, and `rlh-tools` observes it there.
 */
