/**
 * Package-owned invariant companion for `@relay-harness/rlh-tmux-context`.
 * @module @relay-harness/rlh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tmux-context'
