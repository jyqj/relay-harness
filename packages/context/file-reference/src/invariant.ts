/**
 * Package-owned invariant companion for `@relay-harness/rlh-file-reference`.
 * @module @relay-harness/rlh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-file-reference'
