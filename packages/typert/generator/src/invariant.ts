/**
 * Package-owned invariant companion for `@relay-harness/rlh-typert-generator`.
 * @module @relay-harness/rlh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-typert-generator'
