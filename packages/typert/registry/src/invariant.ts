/**
 * Package-owned invariant companion for `@relay-harness/rlh-typert-registry`.
 * @module @relay-harness/rlh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-typert-registry'
