/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-query`.
 * @module @relay-harness/rlh-session-query/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-query'
