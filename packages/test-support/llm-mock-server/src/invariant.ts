/**
 * Package-owned invariant companion for `@relay-harness/rlh-llm-mock-server`.
 * @module @relay-harness/rlh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-llm-mock-server'
