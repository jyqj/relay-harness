/**
 * Package-owned invariant companion for `@relay-harness/rlh-loader-smoke`.
 * @module @relay-harness/rlh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-loader-smoke'
