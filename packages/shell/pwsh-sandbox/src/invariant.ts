/**
 * Package-owned invariant companion for `@relay-harness/rlh-pwsh-sandbox`.
 * @module @relay-harness/rlh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-pwsh-sandbox'
