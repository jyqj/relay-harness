/**
 * Shared rendering helpers for the shell tools (`rlh-tool-bash`,
 * `rlh-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @relay-harness/rlh-shell/render
 */
