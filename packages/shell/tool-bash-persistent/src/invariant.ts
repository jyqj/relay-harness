/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-bash-persistent`.
 * @module @relay-harness/rlh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-bash-persistent'
