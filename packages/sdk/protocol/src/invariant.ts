/**
 * Package-owned invariant companion for `@relay-harness/rlh-sdk-protocol`.
 * @module @relay-harness/rlh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-sdk-protocol'
