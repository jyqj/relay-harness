# @relay-harness/rlh-goal-round-driver
...
```yaml
- id: goal
  name: '@relay-harness/rlh-goal'

- id: tool-goal
  name: '@relay-harness/rlh-tool-goal'

- id: goal-round-driver
  name: '@relay-harness/rlh-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`rlh-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
