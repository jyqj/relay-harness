...
import GoalService, {
  ...
  decodeGoalChange,
  foldGoal,
} from '@relay-harness/rlh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@relay-harness/rlh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@relay-harness/rlh-session').SessionEvent[]): StubAgent {
