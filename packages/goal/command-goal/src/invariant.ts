/**
 * Package-owned invariant companion for `@relay-harness/rlh-command-goal`.
 * @module @relay-harness/rlh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-command-goal'
