 ...
 *
 * @module rlh-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@relay-harness/rlh-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@relay-harness/rlh-llm'
import { attributionHeaders } from '@relay-harness/rlh-llm'
 ...
 * on the length the server claims — the same two-stage shape `rlh-web-fetch`
