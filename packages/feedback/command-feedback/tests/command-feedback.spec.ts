...
import SessionStore, { foldSurface, Session, SessionId } from '@relay-harness/rlh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@relay-harness/rlh-session-telemetry'
...
vi.mock('@relay-harness/rlh-anonymous-user-id', () => ({
...
describe('@relay-harness/rlh-command-feedback registration', () => {
