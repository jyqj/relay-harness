/**
 * Package-owned invariant companion for `@relay-harness/rlh-command-compact`.
 * @module @relay-harness/rlh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-command-compact'
