 ...
 *
 * The seam itself lives in `@relay-harness/rlh-compaction`, which re-exports these
 ...
 * `rlh-commands/brand` shape.
 *
 * @module @relay-harness/rlh-compaction/checkpoint
 */

import type { MessageSource } from '@relay-harness/rlh-llm/message'
