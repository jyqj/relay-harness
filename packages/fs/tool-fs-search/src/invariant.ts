/**
 * Package-owned invariant companion for `@relay-harness/rlh-tool-fs-search`.
 * @module @relay-harness/rlh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-tool-fs-search'
