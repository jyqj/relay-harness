/**
 * Package-owned invariant companion for `@relay-harness/rlh-rollout-budget-controller`.
 * @module @relay-harness/rlh-rollout-budget-controller/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-rollout-budget-controller'
