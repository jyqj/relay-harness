/**
 * Package-owned invariant companion for `@relay-harness/rlh-repeat-tool-reminder`.
 * @module @relay-harness/rlh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-repeat-tool-reminder'
