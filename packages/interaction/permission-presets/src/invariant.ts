/** Package-owned permission-preset event invariants. @module @relay-harness/rlh-permission-presets/invariant */
...
const PACKAGE_NAME = '@relay-harness/rlh-permission-presets'
