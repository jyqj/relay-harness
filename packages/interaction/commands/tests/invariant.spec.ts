...
import * as CommandInvariant from '@relay-harness/rlh-commands/invariant'
...
import { CommandId } from '@relay-harness/rlh-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@relay-harness/rlh-commands',
    }))
  })
