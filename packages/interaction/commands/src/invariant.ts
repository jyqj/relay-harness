/**
 * Package-owned invariant companion for `@relay-harness/rlh-commands`:
 * command lifecycle events pair by commandId within one session log.
 * @module @relay-harness/rlh-commands/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-commands'
