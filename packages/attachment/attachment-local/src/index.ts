/** Local durable attachment backend rooted below `RLH_HOME`. @module @relay-harness/rlh-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveRlhHome(config.rlhHome), 'attachments', 'v1'))
