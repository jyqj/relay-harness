/**
 * Package-owned invariant companion for `@relay-harness/rlh-skill-badge`.
 * @module @relay-harness/rlh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-skill-badge'
