/** Package-owned invariant companion for the directory-picker seam. @module @relay-harness/rlh-host-directory-picker/invariant */

import type { Context } from '@relay-harness/cordis'
import type { InvariantInstaller } from '@relay-harness/rlh-invariants'

const PACKAGE_NAME = '@relay-harness/rlh-host-directory-picker'
