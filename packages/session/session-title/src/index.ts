 ...
 * @module @relay-harness/rlh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@relay-harness/cordis'
import z from '@relay-harness/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@relay-harness/rlh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@relay-harness/rlh-llm'
import type { GenerateOptions } from '@relay-harness/rlh-llm'
import type {
  Session,
  SessionEvent,
