/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-persistence`.
 * @module @relay-harness/rlh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-persistence'
