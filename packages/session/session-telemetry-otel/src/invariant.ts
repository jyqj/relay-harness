/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-telemetry-otel`.
 * @module @relay-harness/rlh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-telemetry-otel'
