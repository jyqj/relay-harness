/**
 * Package-owned invariant companion for `@relay-harness/rlh-session-projection-cache`.
 * @module @relay-harness/rlh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@relay-harness/rlh-session-projection-cache'
