 ...
 * (`deriveStats` in rlh-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @relay-harness/rlh-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@relay-harness/rlh-llm/message'
