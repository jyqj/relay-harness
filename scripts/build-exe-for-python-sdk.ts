...
const DEPLOY_ROOT_PACKAGE = 'rlh-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@relay-harness/rlh-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'rlh-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/relay_harness_runtime/runtime'
