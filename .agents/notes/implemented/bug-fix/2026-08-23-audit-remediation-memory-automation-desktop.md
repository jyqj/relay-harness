...
**Wire `secretEnvironmentNames` into subprocess environment construction.** Rejected for this change: it crosses into the `rlh-subprocess` seam owned by the upstream layout; the declarative reading is documented instead.
