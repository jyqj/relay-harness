...
- Human slash-command discovery and rendering are owned by the separate [`rlh-command-goal`](../../../../packages/goal/command-goal/README.md) plugin.
